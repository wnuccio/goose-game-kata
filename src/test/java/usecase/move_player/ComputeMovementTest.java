...
public class ComputeMovementTest {
    ...
    void compute_regular_movement() {
        ...
        assertThat(movement).isEqualTo(of("Pippo").givenRoll(dice(4, 2)).from(0).to(6).end());
    }
    ...
    void compute_movement_to_ending_position() {
        ...
        assertThat(movement).isEqualTo(of("Pippo").givenRoll(dice(1, 2)).from(60).to(63).end());
    }
    ...
    void compute_movement_with_bouncing() {
        ...
        assertThat(movement).isEqualTo(of("Pippo").givenRoll(dice(2, 3)).from(60).to(61).isBouncing(true).end());
    }
}
